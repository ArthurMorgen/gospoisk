    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
        <div className="mb-10 text-center">
          ...
          <h1 className="mb-3 text-2xl font-bold text-zinc-900 sm:text-3xl">Блог ГосПоиск</h1>
        ...
        <div className="space-y-5">
          {BLOG_POSTS.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group block rounded-2xl border border-zinc-100 bg-white p-6 transition-all hover:border-zinc-200 hover:shadow-lg hover:shadow-zinc-100/80 sm:p-8"
            >
              ...
              <h2 className="mb-2 text-lg font-bold text-zinc-900 transition-colors group-hover:text-blue-600 sm:text-xl">
                {post.title}
              </h2>
