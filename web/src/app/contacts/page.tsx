  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
        <h1 className="mb-2 text-2xl font-bold text-zinc-900 sm:text-3xl">Контакты</h1>
        ...
        <div className="grid gap-5 sm:grid-cols-3">
          <div className="rounded-2xl border border-zinc-100 bg-zinc-50/50 p-6">
            ...
            <h3 className="mb-1 text-sm font-bold text-zinc-900">Email</h3>
          ...
          <div className="rounded-2xl border border-zinc-100 bg-zinc-50/50 p-6">
            ...
            <h3 className="mb-1 text-sm font-bold text-zinc-900">Режим работы</h3>
            <p className="text-sm text-zinc-600">Пн — Пт: 9:00 — 18:00</p>
            <p className="mt-2 text-xs text-zinc-400">
          ...
          <div className="rounded-2xl border border-zinc-100 bg-zinc-50/50 p-6">
            ...
            <h3 className="mb-1 text-sm font-bold text-zinc-900">Адрес</h3>
            <p className="text-sm text-zinc-600">Российская Федерация</p>
            <p className="mt-2 text-xs text-zinc-400">
              Онлайн-сервис
            </p>
          </div>
        ...
        <div className="mt-12 rounded-2xl border border-zinc-100 bg-zinc-50/50 p-6 sm:p-8">
          <h2 className="mb-4 text-lg font-bold text-zinc-900">Часто задаваемые вопросы</h2>
          <div className="space-y-4">
            <div>
              <h3 className="mb-1 text-sm font-semibold text-zinc-800">Как связаться с технической поддержкой?</h3>
            ...
            <div>
              <h3 className="mb-1 text-sm font-semibold text-zinc-800">Как удалить аккаунт и данные?</h3>
              <p className="text-sm text-zinc-500">
                Отправьте запрос на support@gospoisk.ru с темой «Удаление аккаунта» и укажите email, на который зарегистрирован аккаунт.
              </p>
            </div>
            <div>
              <h3 className="mb-1 text-sm font-semibold text-zinc-800">Как оформить возврат средств?</h3>
              <p className="text-sm text-zinc-500">
