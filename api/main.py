...
REGIONS = [
    ...
    "Ростовская область", "Башкортостан", "Татарстан",
    "Тюменская область", "Пермский край", "Воронежская область",
    "Волгоградская область", "Красноярский край", "Саратовская область",
    "Омская область", "Кемеровская область", "Оренбургская область",
    "Иркутская область", "Хабаровский край", "Приморский край",
    "Тульская область", "Рязанская область", "Калужская область",
    "Брянская область", "Тверская область", "Ярославская область",
    "Ставропольский край", "Удмуртия", "Дагестан",
    "Калининградская область", "Архангельская область", "Мурманская область",
    "Владимирская область", "Ивановская область", "Костромская область",
    "Курская область", "Белгородская область", "Липецкая область",
    "Тамбовская область", "Пензенская область", "Ульяновская область",
    "Чувашия", "Марий Эл", "Мордовия",
    "Астраханская область", "Томская область", "Курганская область",
    "Чеченская Республика", "Якутия", "Бурятия",
    "Алтайский край", "Забайкальский край", "Амурская область",
    "Сахалинская область", "Камчатский край",
    "Новгородская область", "Псковская область", "Смоленская область",
    "Орловская область", "Вологодская область", "Коми",
    "Карелия", "Адыгея", "Калмыкия",
    "Крым", "Севастополь",
    "Ханты-Мансийский авт. округ", "Ямало-Ненецкий авт. округ",
]
...
async def get_regions():
    """Список регионов РФ для фильтра"""
